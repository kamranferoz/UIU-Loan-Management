...
--
-- Host: localhost
-- Generation Time: Mar 28, 2016 at 01:19 AM
...
INSERT INTO `loan` (`id`, `user_id`, `amount`, `approved_date`, `distribution_date`, `distribution_method`, `installment_system`, `installment_amount`, `cycle_due_date`, `tenor`, `note`, `status`) VALUES
(1, 3, 100000, 1455195599, 1455195599, 'Cash', 'Monthly', 10000, 1455195599, '2 Years', 'Bukijuki', 'Approved'),
(2, 4, 100000, 1455195599, 1455195599, 'cash', 'Monthly', 16667, NULL, '6', 'For buying a car.', 'Approved'),
(3, 5, 100000, 1459125965, NULL, 'cash', 'Monthly', 16667, NULL, '6', 'For buying a car.', 'Approved'),
(4, 6, 50000, NULL, NULL, 'cash', 'Monthly', 12500, NULL, '4', 'For personal business.', 'Sent to the Department'),
(5, 7, 100000, NULL, NULL, 'cash', 'Monthly', 16667, NULL, '6', 'for starting business.', 'Sent to the Department'),
(6, 8, 10000000, NULL, NULL, 'cash', 'Monthly', 833333, NULL, '12', 'For buying a BMW Z8 car.', 'Sent to the Department'),
(7, 9, 500, NULL, NULL, 'cash', 'Monthly', 125, NULL, '4', 'For buying Dairy Milk chocolate.', 'Sent to the Department'),
(8, 10, 50000, NULL, NULL, 'cash', 'Monthly', 12500, NULL, '4', 'For Semester Fee.', 'Sent to the Department'),
(9, 11, 60000, NULL, NULL, 'cash', 'Monthly', 10000, NULL, '6', 'For semester fee.', 'Sent to the Department'),
(10, 12, 40000, NULL, NULL, 'cash', 'Monthly', 6667, NULL, '6', 'For buying project instrument.', 'Sent to the Department'),
(11, 13, 80000, NULL, NULL, 'cash', 'Monthly', 6667, NULL, '12', 'for startup a business.', 'Sent to the Department'),
(12, 14, 100100, NULL, NULL, 'cash', 'Monthly', 16683, NULL, '6', 'For medical aid', 'Sent to the Department'),
(13, 15, 20000, NULL, NULL, 'cash', 'Monthly', 3333, NULL, '6', 'Apartment rent', 'Sent to the Department'),
(14, 16, 50000, NULL, NULL, 'cash', 'Monthly', 8333, NULL, '6', 'Thesis purpose.', 'Sent to the Department'),
(17, 17, 500000, NULL, NULL, 'cash', 'Monthly', 125000, NULL, '4 Months', 'Going to other university to study', 'Sent to the Department'),
(18, 18, 1000000, NULL, NULL, 'cash', 'Monthly', 250000, NULL, '4 Months', 'Going to Canada', 'Paid in full');
...
(2, 3, 'Mohammad', 'Mainuddin', 'ssaf', '011111111', 3.25, 'House # 17; Road # 4, kaderabad housing ltd.', 'Mohammadpur', '01911111111'),
...
(1, 1, 'Fuad', '202cb962ac59075b964b07152d234b70', 'fuad.robi@gmail.com', 1, '123456', '', '0000-00-00 00:00:00', 1455195410, 1455195410),
